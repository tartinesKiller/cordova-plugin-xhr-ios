...
var ErrorCodes;
(function (ErrorCodes) {
    ErrorCodes[ErrorCodes["Timeout"] = -1001] = "Timeout";
...
var XHR = /** @class */ (function (_super) {
    ...
    XHR.prototype.send = function (data) {
        ...
        promise.then(function (body) { return exec(function (response) {
            ...
            _this.readyState = XMLHttpRequest.DONE;
        }, 'CORS', 'send', [_this.method, _this.path, _this.requestHeaders, body, _this._responseType || 'text', _this.mimeType, _this.timeout]); });
    };
    ...
    XHR.prototype.setRequestHeader = function (header, value) {
        if (value != null) {
            this.requestHeaders[header] = "".concat(value);
        }
        else {
